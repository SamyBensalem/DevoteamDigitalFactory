...
public interface Library {
    ...
    /**
     * method to check if a member is late in giving back a book according to its status of student 
     * or Resident. It puts to true or false a boolean in The super class Member
     * @param member
     */
